...
namespace Trail365.UnitTests.ViewModel
{
    ...
    public class TrailViewModelTest
    {
        ...
        {
            var url = this.Url.GetTrailExplorerUrlOrDefault("https://www.google.com/index",this.EmptyViewModel.GpxUrl, ExplorerMapStyle.Outdoor, System.Drawing.Size.Empty, true, true);
            Debug.WriteLine(url);
        }
    }
}
