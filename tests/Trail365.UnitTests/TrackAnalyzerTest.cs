...
namespace Trail365.UnitTests
{
    ...
    public class TrackAnalyzerTest
    {
        ...
        [Theory]
        [InlineData(System.Math.PI, (double)10000 / NTSExtensions.DeviationFactor, 100, 107, 2)]
        [InlineData(System.Math.PI / 4, (double)10000 / NTSExtensions.DeviationFactor, 94, 107, 6)]
        [InlineData(System.Math.PI / 4, (double)1000 / NTSExtensions.DeviationFactor, 89, 98, 21)]
